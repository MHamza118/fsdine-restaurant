...
Route::prefix('admin')->middleware(['admin'])->group(function () {
    ...
    Route::prefix('faqs')->group(function () {
        ...
        Route::patch('/{id}/toggle-status', [App\Http\Controllers\Api\V1\FaqController::class, 'toggleActive']);
            ...
            Route::prefix('menu')->group(function () {
                Route::get('/categories', [App\Http\Controllers\Api\V1\MenuController::class, 'getCategories']);
                Route::get('/categories/{id}', [App\Http\Controllers\Api\V1\MenuController::class, 'getCategory']);
                Route::post('/categories', [App\Http\Controllers\Api\V1\MenuController::class, 'createCategory']);
                Route::put('/categories/{id}', [App\Http\Controllers\Api\V1\MenuController::class, 'updateCategory']);
                Route::delete('/categories/{id}', [App\Http\Controllers\Api\V1\MenuController::class, 'deleteCategory']);
                
                Route::get('/items', [App\Http\Controllers\Api\V1\MenuController::class, 'getItems']);
                Route::get('/items/{id}', [App\Http\Controllers\Api\V1\MenuController::class, 'getItem']);
                Route::post('/items', [App\Http\Controllers\Api\V1\MenuController::class, 'createItem']);
                Route::put('/items/{id}', [App\Http\Controllers\Api\V1\MenuController::class, 'updateItem']);
                Route::delete('/items/{id}', [App\Http\Controllers\Api\V1\MenuController::class, 'deleteItem']);
            });
    ...
    // Menu public routes (no auth required)
    Route::get('menu/categories', [App\Http\Controllers\Api\V1\MenuController::class, 'getCategories']);
    
    // Customer order routes (no auth required)
    Route::post('customer/orders', [App\Http\Controllers\Api\V1\CustomerOrderController::class, 'placeOrder']);
    Route::post('customer/validate-table', [App\Http\Controllers\Api\V1\CustomerOrderController::class, 'validateTableNumber']);
});
